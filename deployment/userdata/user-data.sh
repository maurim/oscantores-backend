...
git clone -b develop https://github.com/maurim/oscantores-backend.git # replace this github url with your url of your own project
cd backend # set your project name
npm install
aws s3 sync s3://oscantores-env-files/develop . # update with your s3 bucket
unzip env-file.zip
cp .env.develop .env
npm run build
npm run start
