...
export class Add {
  ...
  public async message(req: Request, res: Response): Promise<void> {
    ...
    const conversationObjectId: any | ObjectId = !conversationId ? new ObjectId() : new mongoose.Types.ObjectId(conversationId);
    const mongoId: string | any = new ObjectId(conversationObjectId)
