...
export class Create {
  ...
  public async post(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.CREATED).json({ message: 'Post criado com sucesso' });
  }
  ...
  public async postWithImage(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.CREATED).json({ message: 'Postagem criada com imagem, sucesso!' });
  }
